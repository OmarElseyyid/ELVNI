...
<head>
    ...
    <link rel="manifest" href="img/site.webmanifest.html">
    <meta name="msapplication-TileColor" content="#da532c">
    <meta name="theme-color" content="#ffffff">
    <link rel="stylesheet" href="css/main.css@id=d3f5e3225442a08261f7.css" />
    ...
    <meta content="https://media.tdp-arch.com/_1200x630_crop_center-center_82_none/TDP-site.PNG?mtime=1583357830"
        property="og:image">
...
<body class="home">
    <section id="home-intro" class="hero full home">
        <iframe src="https://player.vimeo.com/video/386235859?app_id=122963&background=1" width="480" height="270"
            frameborder="0" allow="autoplay; fullscreen" allowfullscreen="" title="Real Estate Reel 2014"></iframe>
        <div class="icon-scroll"></div>
    </section>
    <header>
        <span class="hamburger"><span></span></span>
        <a class="logo" href="index.html"><img src="img/logo.svg" alt="Torgerson Design Partners" /></a>
        <nav class="primary">
            <ul>
                <li>
                ...
                <li>
                    <a class="" href="industries.html">Industries<span class="toggle"><i
                ...
                <li>
                    <a class="" href="about.html">About<span class="toggle"><i class="far fa-plus"></i><i
                                class="far fa-minus"></i></span></a>
                    <div class="dropdown">
                        <ul>
                ...
                <li><a href="start-your-project.html" target=""><span>Start Your Project <i
                    ...
                    <article>
                        <div class="grid grid-lg">
                            <div class="unit-1-2 unit-1-1-md unit-vertical-center margin-bottom">
                                <img class="full"
                                    src="https://media.tdp-arch.com/_rectangle/Architecture-Slider.png"
                    ...
                    <article>
                        <div class="grid grid-lg">
                            ...
                            <div class="unit-1-2 unit-1-1-md unit-vertical-center margin-bottom">
                                ...
                                <p><a class="inline-button margin-top"
                                        href="services/commercial-property-for-sale.html" target="">Learn more <i
                                            class="far fa-chevron-right"></i></a></p>
                            </div>
                        </div>
                    </article>
                ...
                <div class="grid grid-lg grid-center padding-top-sm">
                    <div class="unit-1-4 unit-1-2-md unit-1-1-sm margin-bottom-md">
                        <div class="text-center">
                            <h2 class="icon margin-bottom-sm">
                                <img class="animated-icon invisible"
                                    src="https://media.tdp-arch.com/Calendar_Icon.gif"
                    ...
                    <div class="unit-1-4 unit-1-2-md unit-1-1-sm margin-bottom-md">
                        <div class="text-center">
                            <h2 class="icon margin-bottom-sm">
                                <img class="animated-icon invisible"
                                    src="https://media.tdp-arch.com/Building_Icon2.gif"
                    ...
                    <div class="unit-1-3 unit-1-2-md unit-1-1-sm margin-bottom"
                        ...
                        <a class="tile" href="portfolio/amgh-headquarters.html"
                            ...
                            <div class="content">
                                <div>
                                    <h6><span class="text-red">/</span>Emergency Services</h6>
                                    <h5>Air Medical Group National Headquarters&nbsp;<i
                                            class="far fa-chevron-right"></i></h5>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="carousel-container">
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/7-16-2-1.html"
                            ...
                            <div class="content">
                                ...
                                <p>Friday Five: 417&#039;s Best Events 9/3-9/9&nbsp;<i
                    ...
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/7-16-2.html"
                            ...
                            <div class="image">
                                <img src="https://media.tdp-arch.com/_rectangle/main_210730_161508.png"
                                    alt="Main" />
                            </div>
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 7/30-8/4&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/7-16-1.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 7/23-7/29&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/7-16.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 7/16-7/22&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/6-25.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 7/2-7/8&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/5-14-21-1-2.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 6/11-6/17&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/5-14-21-1-1.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 6/4-6/10&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/5-14-21-1.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 5/28-6/3&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/5-14-21.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 5/14-5/20&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/5-7.html"
                            ...
                            <div class="image">
                                <img src="https://media.tdp-arch.com/_rectangle/Mothersd-day.png"
                                    alt="Mothersd day" />
                            </div>
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 5/7-5/13&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/4-30-21.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 4/30-5/6&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/11-20-1-1.html"
                            ...
                            <div class="image">
                                <img src="https://media.tdp-arch.com/_rectangle/Main_210122_150258.png"
                                    alt="Main" />
                            </div>
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 1/22-1/28&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/11-20-1.html"
                            ...
                            <div class="image">
                                <img src="https://media.tdp-arch.com/_rectangle/main_201216_164204.png"
                                    alt="Main" />
                            </div>
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                    ...
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/9-25.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 9/25-10-1&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/8-28.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 8/28 - 9/3&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/7-31-1.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 8/7- 8/13&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/7-31.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 7/31- 8/6&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="carousel-item" data-aos="fade-left" data-aos-delay="100">
                        <a class="card" href="news-updates/7-24.html"
                            ...
                            <div class="content">
                                <h6><span class="text-red">/</span>Hometown News</h6>
                                <p>Friday Five: 417&#039;s Best Events 7/24- 7/30&nbsp;<i
                                        class="far fa-chevron-right"></i></p>
                            </div>
                        </a>
                    </div>
        ...
        <div class="container">
            <div class="grid grid-lg">
                <div class="unit-2-5 unit-1-1-md unit-1-1-sm unit-vertical-center margin-bottom">
                    <a class="logo" href="index.html"><img src="img/logo-inverse.svg"
    ...
    <script src="js/vendor.js@id=2dc5042273cace482b2d"></script>
    <script src="js/main.js@id=bcf81981eefde18ebf2e"></script>
    <script type="application/ld+json">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "author": {
                    "@id": "https://www.tdp-arch.com#identity"
                },
                "copyrightHolder": {
                    "@id": "https://www.tdp-arch.com#identity"
                },
                "copyrightYear": "2019",
                "creator": {
                    "@id": "https://www.tdp-arch.com#creator"
                },
                "dateModified": "2022-06-07T14:13:47-05:00",
                "datePublished": "2019-10-18T10:29:00-05:00",
                "description": "Meet Torgerson Design Partners, a full-service architecture firm based in Ozark, Mo. composed of commercial property developers, architects, and designers.",
                "headline": "Home | Torgerson Design Partners | Commercial Property Developers",
                "image": {
                    "@type": "ImageObject",
                    "url": "https://media.tdp-arch.com/_1200x630_crop_center-center_82_none/TDP-site.PNG?mtime=1583357830"
                },
                "inLanguage": "en-us",
                "mainEntityOfPage": "https://www.tdp-arch.com/",
                "name": "Home | Torgerson Design Partners | Commercial Property Developers",
                "publisher": {
                    "@id": "https://www.tdp-arch.com#creator"
                },
                "url": "https://www.tdp-arch.com"
            }, {
                "@id": "https://www.tdp-arch.com#identity",
                "@type": "LocalBusiness",
                "address": {
                    ...
                    "postalCode": "65721",
                    "streetAddress": "116 North 2nd. Avenue"
                },
                "alternateName": "TDP",
                "description": "Founded in 2010, Torgerson Design Partners is a full-service architecture firm located in Ozark, Missouri.",
                "email": "info@tdp-arch.com",
                "foundingDate": "2010",
                "foundingLocation": "Ozark, Mo.",
                "geo": {
                    "@type": "GeoCoordinates",
                    "latitude": "37.020664",
                    "longitude": "-93.204397"
                ...
                "image": {
                    "@type": "ImageObject",
                    "height": "4784",
                    "url": "https://364428868406-production-tdp.s3.amazonaws.com/TDP_Logo_Primary.png",
                    "width": "14834"
                },
                "logo": {
                    "@type": "ImageObject",
                    "height": "60",
                    "url": "https://media.tdp-arch.com/_600x60_fit_center-center_82_none/TDP_Logo_Primary.png?mtime=1573601079",
                    "width": "186"
                },
                "name": "Torgerson Design Partners",
                "priceRange": "$",
                "telephone": "(417) 581-8889",
                "url": "https://www.tdp-arch.com"
            }, {
                "@id": "#creator",
                "@type": "Organization"
